...
//                out.println(String.format("<h1>x = %d,y = %d,%d %s %d=%d </h1>",x,y,x,operator,y,result));
//                out.println(sc.toString());
                // %2B จะเป็นเครื่องหมาย + , ถ้า + ไปเลย มันจะเป็นช่องว่างจ้า
//                out.println("<p> test operator ="+operator+"</p>");
//                out.println("</body>");
//                out.println("</html>");
            } catch (Exception e) {
                out.println("<!DOCTYPE html>");
